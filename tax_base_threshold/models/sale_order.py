...
class SaleOrder(models.Model):
    ...
    @api.depends('order_line.tax_id', 'order_line.price_subtotal')
    def _compute_withholding_info(self):
        ...
        for order in self:
            ...
            taxes_with_concepts = order.order_line.mapped('tax_id').filtered(
    ...
    @api.depends('order_line.tax_id', 'order_line.price_unit', 'amount_total', 'amount_untaxed', 'currency_id', 'date_order')
...
class SaleOrderLine(models.Model):
    ...
    @api.depends('tax_id', 'price_subtotal', 'order_id.partner_id')
    def _compute_withholding_status(self):
        ...
        for line in self:
            ...
            for tax in line.tax_id.filtered(lambda t: t.use_withholding_concept and t.withholding_concept_id):
                concept = tax.withholding_concept_id
