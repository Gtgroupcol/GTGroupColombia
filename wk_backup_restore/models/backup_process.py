...
class BackupProcess(models.Model):
    ...
    storage_path = fields.Char(string="Storage Path", default="/opt/odoo17/backups", help="The directory path where the backup files will be stored on the server. Por defecto: /opt/odoo17/backups", tracking=True)
