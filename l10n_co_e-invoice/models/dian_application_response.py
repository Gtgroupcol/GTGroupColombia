...
class DianApplicationResponse(models.Model):
    ...
    def _get_common_template_vals(self):
        ...
        if not self.user_id.partner_id.vat_vd:
        ...
        return {
                ...
                "SenderSchemeID": self.company_id.partner_id.vat_vd,
                ...
                "notes": '',
                "PersonSchemeID": self.user_id.partner_id.vat_vd,
                ...
                "SoftwareProviderSchemeID": self.company_id.partner_id.vat_vd,
    ...
    def generate_from_electronic_invoice(self, id_e, response_type):
        ...
        template_vals.update({
                ...
                "CustomerschemeID":  data.partner_id.vat_vd or "1", 
