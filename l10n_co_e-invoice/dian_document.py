...
class DianDocument(models.Model):
    ...
    def _get_dian_constants(self, data_header_doc):
        ...
        if partner.city_id:
            dian_constants["SupplierCountrySubentityCode"] = partner.city_id.code_dian[0:2]  # Ciudad o departamento tabla 6.4.2 res.country.state
        dian_constants[
            "SupplierCountryCode"
        ...
        dian_constants["schemeID"] = partner.vat_vd # Digito verificador del NIT
    ...
    def _generate_data_constants_document(
        ...
        if (
            self.return_number_document_type(partner_to_send.l10n_latam_identification_type_id.l10n_co_document_code if partner_to_send.l10n_latam_identification_type_id else "")
            == 31
        ):
            ...
            data_constants_document["SchemeIDAdquiriente"] = partner_to_send.vat_vd #or ''
        else:
            data_constants_document["IDAdquiriente"] = (
                partner_to_send.vat_co if partner_to_send.vat_co else ""
            )
        ...
        data_constants_document["SupplierSchemeName"] = self.return_number_document_type(self.document_id.partner_id.l10n_latam_identification_type_id.l10n_co_document_code if self.document_id.partner_id.l10n_latam_identification_type_id else "")
        ...
        data_constants_document["CustomerSchemeID"] = self.return_number_document_type(
            partner_to_send.l10n_latam_identification_type_id.l10n_co_document_code if partner_to_send.l10n_latam_identification_type_id else ""
        ...
        if partner_to_send.city_id:
            data_constants_document["CustomerCountrySubentityCode"] = partner_to_send.city_id.state_id.code_dian # Ciudad o departamento tabla 6.4.2 res.country.state
        ...
        data_constants_document[
            "CustomerschemeID"
        ] = partner_to_send.vat_vd #or ''  # Digito verificador del NIT
